//This object will allow me to convert a number to a spanish string. Based on the
//implementation given by Jose Felix Gomez in
//http://github.com/jfgomez86/number-to-words

//Usage: 
//<script type="text/javascript"> alert(NumberToWord(3463)); </script>
//That will show an alert window saying: tres mil cuatrocientos sesenta y tres
